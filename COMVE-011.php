                            ...
                            while ($stmt->fetch()) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-info btn-sm" href="COMVE-011-Editar.php?id=<?php echo $ID_Cotizacion; ?>" onclick="return confirm('¿Seguro que deseas editar este registro?')">
                                            <i class="fas fa-pencil-alt"></i>
                                            Editar
                                        </a>

                                        <a class="btn btn-danger btn-sm" href="COMVE-011-Eliminar.php?id=<?php echo $ID_Cotizacion; ?>" onclick="return confirm('¿Seguro que deseas eliminar este registro?')">
