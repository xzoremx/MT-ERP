    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <form action="COMVE-010.php" method="post" onsubmit="saveDate()">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-6">
                                <label>Fecha:</label>
                                <input type="date" class="form-control" name="fecha" value="">
                                <button type="button" onclick="clearDate()" class="btn btn-danger">Limpiar fecha</butt
                              </div>
                            </div>
                            <div class="col-6">
            ...
            <!-- /.card-header -->
            <style>
        /* Cambia el color de fondo de los encabezados de la tabla a blanco y el texto a negro */
        th {
            background-color: #fff;
            color: #000; /* Texto en negro */
        }

        /* Cambia el color de fondo de las filas impares de la tabla a blanco */
        tr:nth-child(odd) {
            background-color: #fff;
        }

        /* Cambia el color del texto de las celdas de la tabla a negro */
        td {
            color: #000; /* Texto en negro */
        }
    </style>
              ...
              $sql = "SELECT * FROM ordenes_de_cotizacion";
              if (!empty($fecha)) {
                  $sql .= " WHERE fecha = ?";
              }
              ...
              if ($stmt) {
                  ...
                  $stmt->bind_result($ID_Cotizacion, $fecha, $ID_Cliente, $Nombre_del_Cliente, $Servicio, $Producto, $Cargo, $ID_Responsable, $Estado, $fechasistema);
              }
              ?>
                <style>
        table {
                        ...
                        if ($total_registros > 0) { //Existen datos
                            while ($stmt->fetch()) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($ID_Responsable); ?></td>
...
<script>
    ...
    function exportToExcel() {
      ...
      var exportUrl = "COMVE-010-EXCEL.php" + (fecha ? "?fecha=" + encodeURIComponent(fecha) : "");
      window.location.href = exportUrl;
    }

    function exportToPDF() {
      var fecha = document.getElementById("fecha").value;
      var exportUrl = "COMVE-010-PDF.php" + (fecha ? "?fecha=" + encodeURIComponent(fecha) : "");
      window.location.href = exportUrl;
    }
  </script>
